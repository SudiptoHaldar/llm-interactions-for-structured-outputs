"""Tests for Cohere batch country processing CLI."""

from unittest.mock import MagicMock, patch

import pytest

from process_structured_output.cli_all_countries_cohere import main


class TestBatchCLI:
    """Tests for all-countries-cohere CLI."""

    @patch("process_structured_output.cli_all_countries_cohere.get_countries_by_llm")
    @patch("process_structured_output.cli_all_countries_cohere.process_country")
    def test_dry_run_lists_countries(
        ...
        mock_get_countries.return_value = ["Japan", "Germany"]
    ...
    def test_returns_error_on_any_failure(
        ...
        mock_process.side_effect = [
            {"ai_model_id": 1, "country_id": 1},  # Japan succeeds
            ValueError("API error"),  # Germany fails
        ]
    ...
    def test_skip_cities_passed_through(
        ...
        mock_get_countries.return_value = ["Japan"]
        mock_process.return_value = {"ai_model_id": 1, "country_id": 1}
